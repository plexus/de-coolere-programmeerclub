...
shapes = [growing] #[S,Z,I,O,J,L,T,P]
...
discord_webhook_url = 'https://discord.com/api/webhooks/1024707197902528612/4jh9BbwEc3pRvAWDgX7tvsPlzDktckkELPeviLoEGG05eqqmAVR3H55VUVgbHqy9eYnx'

def post_to_discord(bericht):
    requests.post(discord_webhook_url, {"content": bericht})
...
def main():
    ...
    if Score[0] > 100:
        post_to_discord("Arne's score bij Tetris is" + str(Score[0]) + ", goed zo!")
    else:
        post_to_discord("Arne's score bij Tetris is" + str(Score[0]) + ", n00b!")
    pygame.display.update()
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pos[0] > 188 and pos[0] < 618:
                    if pos[1] > 379 and pos[1] < 442:
                        main()
                    elif pos[1] > 442:
                        run = False
...
# - [X] creeper face
# - [X] fast drop met spatie
# 3: 1 1 1 - score posten naar discord
# 3 : 3 - press play to start / quit -> knop
# - versnellen

# 6: 2 2 2 - muziek aan toevoegen
# pauzeknop
